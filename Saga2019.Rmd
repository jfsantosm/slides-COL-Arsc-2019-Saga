...
$y_{i,t}−y_{i,t−1}$. If we consider there is a  fixed effect  $\mu_i$ related to location $i$, it is possible to present the value at each location for time $t$ as the sum of some intrinsic value and the fixed effect. $y_{i,t} = y*_{i,t} + \mu_i$ (Geoda documentation 2018)
